...
public class MainBuses {
    public static void main(String [] args) {
        ...
        try {
            ...
            servicio.leeBuses("src\\main\\java\\org\\uma\\mbd\\mdBusV1\\buses.txt");
            Criterio cr1 = new PorLinea(21);
            servicio.guarda("src\\main\\java\\org\\uma\\mbd\\mdBusV1\\linea21.txt", cr1);
            servicio.guarda(new PrintWriter(System.out,true), cr1);
            Criterio cr2 = new EnMatricula("29");
            servicio.guarda("src\\main\\java\\org\\uma\\mbd\\mdBusV1\\contiene29.txt", cr2);
